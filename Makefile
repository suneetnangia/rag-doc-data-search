...
#   Ollama also supports Nvidia GPUs. If you are running outside of dev container, please see https://github.com/ollama/ollama/blob/main/docs/docker.md#nvidia-gpu
