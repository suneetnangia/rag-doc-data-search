...
{
    Task AddDocumentAsync(LanguageModel<VectorEmbeddings> embeddingsLanguageModel, Guid documentId, VectorDbPayload document, CancellationToken cancellationToken);
