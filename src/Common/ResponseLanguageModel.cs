...
public class ResponseLanguageModel : LanguageModel<VectorDocument>
{
    ...
    public override async Task<VectorDocument> Generate(Uri ollamaBaseUrl, string languageModelName, string text)
    {
        throw new NotImplementedException();
    }
}
